...
import LockedInput from '../../../component/ui/form/locked-input'

const TeamProfileMain = () => {
    ...
    <div className={'profilePage'}>
        ...
        <div className="workInfo-content">
          ...
          <div className="mainCont">
            <div className="subCont">
              <LockedInput defaultValue={"Creative & Pre-Production"} label={"Department"} />
              <LockedInput defaultValue={"Phase 8"} label={"Location"} />
              <LockedInput defaultValue={"Cinematographer & Video Editor"} label={"Designation"} />
            </div>

            <div className="subCont">
              <LockedInput defaultValue={"Manager"} label={"Role"} />
              <LockedInput defaultValue={"Permanent"} label={"Employment Type"} />
              <LockedInput defaultValue={"Active"} label={"Employee Status"} />
              <LockedInput defaultValue={"Direct"} label={"Source of Hire"} />
              <LockedInput defaultValue={"20-Mar-2025"} label={"Date of Joining"} />
              <LockedInput defaultValue={"1 month(s)"} label={"Current Experience"} />
              <LockedInput defaultValue={"1 month(s)"} label={"Total Experience"} />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="card workInfoCard">
        <div className="workInfo-content">
          ...
          <div className="mainCont">
            <div className="subCont">
              <LockedInput defaultValue={"Schergeil Parvez 1"} label={"Reporting Manager"} />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="card workInfoCard">
        <div className="workInfo-content">
          ...
          <div className="mainCont">
            <div className="subCont">
              <LockedInput defaultValue={"14 Dec 1988"} label={"Date of Birth"} />
              <LockedInput defaultValue={"37"} label={"Age"} />
              <LockedInput defaultValue={"Male"} label={"Gender"} />
              <LockedInput defaultValue={"Married"} label={"Marital Status"} />
              <LockedInput defaultValue={"-"} label={"About Me"} />
            </div>

            <div className="subCont">
              <LockedInput defaultValue={"Manager"} label={"Ask me about/Expertise"} />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="card workInfoCard">
        <div className="workInfo-content">
          ...
          <div className="mainCont">
            <div className="subCont">
              <LockedInput label={"Work Phone Number"} defaultValue={"14 Dec 1988"} />
              <LockedInput label={"Extension"} defaultValue={"37"} />
              <LockedInput label={"Seating Location"} defaultValue={"Male"} />
              <LockedInput label={"Tags"} defaultValue={"Married"} />
              <LockedInput label={"Present Address"} defaultValue={"-"} />
              <LockedInput label={"Permanent Address"} defaultValue={"-"} />
            </div>

            <div className="subCont">
              <LockedInput label={"Ask me about/Expertise"} defaultValue={"Manager"} />
              <LockedInput label={"Ask me about/Expertise"} defaultValue={"Manager"} />
            </div>
          </div>
        </div>
...
export default TeamProfileMain
